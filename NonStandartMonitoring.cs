...
namespace PDF_Report
{
    public class NonStandartMonitoring
    {
        ...
        public Dictionary<string, string> ParamsReplace = new Dictionary<string, string>()
        {
            {"[ABB]", "0" },
            {"[YEAR]", "0" },
            {"[ION_NAME]", "0" },
